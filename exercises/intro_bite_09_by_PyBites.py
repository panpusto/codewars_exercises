...
# Complete get_workout_motd that receives a day string, title case it so the function can receive
# case insensitive days, look it up in the dict and do two things:
#
# If the day (key) is not in the dictionary, return INVALID_DAY, we don't want this function to continue.
# If the key is in the dictionary, return CHILL_OUT or TRAIN depending if it's a REST day or not.
...
def get_workout_motd(day):
    ...
    elif 'Rest' in WORKOUT_SCHEDULE[day]:
        return CHILL_OUT
